...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1513200330, 164482, 1e0fffff, 1, 50 * COIN);
        ...
        vSeeds.push_back(CDNSSeedData("node.walletbuilders.com", "node.walletbuilders.com", true)); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.push_back(CDNSSeedData("195.110.59.120", "31.220.60.129", true)); // Matt Corallo, only supports x9
